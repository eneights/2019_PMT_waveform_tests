...
def p1b(start, end, dest_path, nhdr):
    ...
    plot_histogram(charge_array, dest_path, 100, 'Charge', 'Charge', 'C', 'charge_d1b', 8e-13, 1.75e-12)
    plot_histogram(amplitude_array, dest_path, 100, 'Voltage', 'Amplitude', 'V', 'amplitude_d1b', 0.004, 0.009)
    plot_histogram(fwhm_array, dest_path, 100, 'Time', 'FWHM', 's', 'fwhm_w_outliers', 7.1e-9, 8.2e-9)
    plot_histogram(rise1090_array, dest_path, 100, 'Time', '10-90 Rise Time', 's', 'rise1090_d1b', 2.5e-9, 3.5e-9)
    plot_histogram(rise2080_array, dest_path, 100, 'Time', '20-80 Rise Time', 's', 'rise2080_d1b', 1.8e-9, 2.3e-9)
    plot_histogram(fall1090_array, dest_path, 100, 'Time', '10-90 Fall Time', 's', 'fall1090_d1b', 1.5e-8, 1.9e-8)
    plot_histogram(fall2080_array, dest_path, 100, 'Time', '20-80 Fall Time', 's', 'fall2080_d1b', 9.5e-9, 1.2e-8)
    plot_histogram(time10_array, dest_path, 100, 'Time', '10% Jitter', 's', 'time10_d1b', -2e-9, -1e-9)
    plot_histogram(time20_array, dest_path, 100, 'Time', '20% Jitter', 's', 'time20_d1b', -1.3e-9, -5e-10)
    plot_histogram(time80_array, dest_path, 100, 'Time', '80% Jitter', 's', 'time80_d1b', 8e-10, 11e-10)
    plot_histogram(time90_array, dest_path, 100, 'Time', '90% Jitter', 's', 'time90_d1b', 11e-10, 16e-10)
